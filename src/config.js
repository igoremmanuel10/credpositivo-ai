...
export const config = {
  ...
  krayin: {
    ...
    apiToken: process.env.KRAYIN_API_TOKEN || '',
    pipelineId: process.env.KRAYIN_PIPELINE_ID || '1',
  },
  ...
  limits: {
    ...
    followupDelays: [24 * 60, 24 * 60, 48 * 60, 48 * 60],
    conversationTimeoutMinutes: 24 * 60,
    debounceSeconds: 3,
    cooldownSeconds: 10,
